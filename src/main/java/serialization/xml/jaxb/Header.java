...
@XmlType(name = "", propOrder = { "reference", "from", "to", "subject" })
...
public class Header {
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = { "name", "identity", "countryCode", "ministryCode", "organizationCode", "unitCode" })
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = { "version", "messageId" })
   ...
   */
  @XmlAccessorType(XmlAccessType.FIELD)
  @XmlType(name = "", propOrder = { "documentType", "type", "function", "reference", "preReference", "documentYear", "sendDate" })
