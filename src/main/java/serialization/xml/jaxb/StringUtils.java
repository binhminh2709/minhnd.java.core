...
public class StringUtils {
  ...
  */
   ...
   *
   */
  public static final String encodeFrom(String text, String srcEnc) throws java.io.UnsupportedEncodingException {
    if (text == null) {
      return null;
    }
   ...
   *
   */
  public static final String encodeFromISO8859(String text) throws java.io.UnsupportedEncodingException {
    if (text == null) {
      return null;
    }
   ...
   *
   */
  public static final String encodeTo(String text, String targetEnc) throws java.io.UnsupportedEncodingException {
    if (text == null) {
      return null;
    }
  ...
  public static void testFormat() {
    ...
    for (int i = total; i >= 0; i--) {
      ...
      buffer.append(formatStr("[" + count++ + "] LEFT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(formatStr(testStr, 11, StringUtils.ALIGN_LEFT, fill)).append("\n")
          .append(formatStr("[" + count++ + "] LEFT ", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(formatStr(testStr, 20, StringUtils.ALIGN_LEFT, fill)).append("\n")
          .append(formatStr("[" + count++ + "] LEFT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(formatStr(testStr, 6, StringUtils.ALIGN_LEFT, fill)).append("\n")
          .append(formatStr("[" + count++ + "] RIGHT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(formatStr(testStr, 11, StringUtils.ALIGN_RIGHT, fill)).append("\n")
          .append(formatStr("[" + count++ + "] RIGHT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(formatStr(testStr, 20, StringUtils.ALIGN_RIGHT, fill)).append("\n")
          .append(formatStr("[" + count++ + "] RIGHT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(formatStr(testStr, 6, StringUtils.ALIGN_RIGHT, fill)).append("\n");
    ...
    for (int i = total; i >= 0; i--) {
      ...
      buffer.append(format("[" + count++ + "] LEFT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(format(testStr, 11, StringUtils.ALIGN_LEFT, fill)).append("\n")
          .append(format("[" + count++ + "] LEFT ", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(format(testStr, 20, StringUtils.ALIGN_LEFT, fill)).append("\n")
          .append(format("[" + count++ + "] LEFT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(format(testStr, 6, StringUtils.ALIGN_LEFT, fill)).append("\n")
          .append(format("[" + count++ + "] RIGHT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(format(testStr, 11, StringUtils.ALIGN_RIGHT, fill)).append("\n")
          .append(format("[" + count++ + "] RIGHT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(format(testStr, 20, StringUtils.ALIGN_RIGHT, fill)).append("\n")
          .append(format("[" + count++ + "] RIGHT", 12, StringUtils.ALIGN_LEFT, ' '))
          .append(format(testStr, 6, StringUtils.ALIGN_RIGHT, fill)).append("\n");
