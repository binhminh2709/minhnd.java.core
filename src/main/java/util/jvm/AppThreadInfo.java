...
public class AppThreadInfo implements Serializable {
  ...
  public String getThreadBlockTime() {
    return threadBlockTime;
  }
  
  public void setThreadBlockTime(String threadBlockTime) {
  ...
  public void setThreadWaitedCount(String threadWaitedCount) {
    this.threadWaitedCount = threadWaitedCount;
  }
  
  public String getThreadWaitedTime() {
    return threadWaitedTime;
  }
  
  public void setThreadWaitedTime(String threadWaitedTime) {
  ...
  public String getThreadUserTime() {
    return threadUserTime;
  }
  
  public void setThreadUserTime(String threadUserTime) {
  ...
  public void setThreadStackTrace(String threadStackTrace) {
