...
public class JVMInfo implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = -6399139042371890263L;
  ...
  public JVMInfo() {
    this.startTime = DateUtils.asCompactDateTime(ManagementFactory.getRuntimeMXBean().getStartTime());
