...
public class MeomoryLeak {
  ...
  public void noLeak(int size) {
    ...
    //Though highest memory allocation happens in this function,
    //but all these objects get garbage collected at the end of this method, so no leak.
  }
  
  public static void main(String[] args) throws IOException {
    MeomoryLeak javaLeaks = new MeomoryLeak();
    for (int i = 0; true; i++) {
      ...
      javaLeaks.slowlyLeakingVector(500000, 10);
      //javaLeaks.leakingRequestLog(500000);
      //javaLeaks.noLeak(500000);
    }
  }
}
